...
extern uint8_t I2C0_SendData( uint8_t SlaveAddr,uint8_t *pTxbuffer, uint32_t Len);

extern uint8_t I2C0_ReceiveData( uint8_t SlaveAddr,uint8_t *pRxbuffer, uint32_t Len);
/**********************************************
// IIC Write Command
**********************************************/
void Write_IIC_Command(unsigned char IIC_Command){
	...
	I2C0_SendData(IIC_SLAVE_ADDR, data, 2);
	return;
}
/**********************************************
// IIC Write Data
...
{
	OLED_WR_Byte(0X8D,OLED_CMD);  //SET DCDCÃƒÃ¼Ã�Ã®
...
void OLED_Display(void)
{
	...
	{
		OLED_WR_Byte (YLevel+i,OLED_CMD);    //Ã‰Ã¨Ã–ÃƒÃ’Â³ÂµÃ˜Ã–Â·Â£Â¨0~7Â£Â©
		OLED_WR_Byte (XLevelL,OLED_CMD);      //Ã‰Ã¨Ã–ÃƒÃ�Ã”ÃŠÂ¾ÃŽÂ»Ã–ÃƒÂ¡ÂªÃ�Ã�ÂµÃ�ÂµÃ˜Ã–Â·
		OLED_WR_Byte (XLevelH,OLED_CMD);      //Ã‰Ã¨Ã–ÃƒÃ�Ã”ÃŠÂ¾ÃŽÂ»Ã–ÃƒÂ¡ÂªÃ�Ã�Â¸ÃŸÂµÃ˜Ã–Â·
		for(n=0;n<WIDTH;n++)
		{
